...
export enum LanguageEN {
  ...
  PROJECT_REINSTATED_DESCRIPTION = "Your project has been successfully reinstated.",
  PROJECT_REINSTATED_ERROR_DESCRIPTION = "An error occurred while reinstating your project.",
  PROJECTED_REINSTATED_ERROR = "Project could not be reinstated",
  ...
  REINSTATE_PROJECT_DESCRIPTION = "Are you sure you want to reinstate this project?",
  YES = "Yes",
  NO = "No",
